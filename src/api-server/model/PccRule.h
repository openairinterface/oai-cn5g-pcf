...
public:
    ...
    void unsetAppReloc();
    /// <summary>
    /// A reference to the QoSData policy type decision type. It is the qosId described in subclause 5.6.2.8.
    /// </summary>
    ...
    /// <summary>
    /// A Reference to the QoS Data policy decision type for the Alternative QoS parameter sets of the service data flow.
    /// </summary>
    ...
    /// <summary>
    /// A reference to the QosMonitoringData policy type decision type. It is the qmId described in subclause 5.6.2.40.
    /// </summary>
