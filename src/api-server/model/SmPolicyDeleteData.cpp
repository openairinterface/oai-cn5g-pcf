...
void SmPolicyDeleteData::setRanNasRelCauses(std::vector<RanNasRelCause> const& value)
{
...
void SmPolicyDeleteData::setAccuUsageReports(std::vector<AccuUsageReport> const& value)
{
