...
void PartialSuccessReport::setRuleReports(std::vector<RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<SessionRuleReport> PartialSuccessReport::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void PartialSuccessReport::setSessRuleReports(std::vector<SessionRuleReport> const& value)
{
