...
public:
    ...
    void setReqQosMonParams(std::vector<RequestedQosMonitoringParameter> const& value);
    ...
    void unsetRepFreqs();
    /// <summary>
    /// Unsigned integer identifying a period of time in units of miliiseconds for DL packet delay.
    /// </summary>
    ...
    /// <summary>
    /// Unsigned integer identifying a period of time in units of miliiseconds for UL packet delay.
    /// </summary>
    ...
    /// <summary>
    /// Unsigned integer identifying a period of time in units of miliiseconds for round trip packet delay.
    /// </summary>
