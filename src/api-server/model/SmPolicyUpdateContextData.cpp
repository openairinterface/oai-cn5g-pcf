...
bool SmPolicyUpdateContextData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<PolicyControlRequestTrigger>& value = m_RepPolicyCtrlReqTriggers;
...
std::vector<PolicyControlRequestTrigger> SmPolicyUpdateContextData::getRepPolicyCtrlReqTriggers() const
{
    return m_RepPolicyCtrlReqTriggers;
}
void SmPolicyUpdateContextData::setRepPolicyCtrlReqTriggers(std::vector<PolicyControlRequestTrigger> const& value)
{
...
void SmPolicyUpdateContextData::setAccNetChIds(std::vector<AccNetChId> const& value)
{
    m_AccNetChIds = value;
...
void SmPolicyUpdateContextData::setAddAccessInfo(AdditionalAccessInfo const& value)
{
...
void SmPolicyUpdateContextData::setRelAccessInfo(AdditionalAccessInfo const& value)
{
...
void SmPolicyUpdateContextData::setRelIpv6AddressPrefix(Ipv6Prefix const& value)
{
...
void SmPolicyUpdateContextData::setAddIpv6AddrPrefixes(Ipv6Prefix const& value)
{
...
void SmPolicyUpdateContextData::setAddRelIpv6AddrPrefixes(Ipv6Prefix const& value)
{
...
void SmPolicyUpdateContextData::setSubsDefQos(SubscribedDefaultQos const& value)
{
    m_SubsDefQos = value;
...
std::vector<AccuUsageReport> SmPolicyUpdateContextData::getAccuUsageReports() const
{
    return m_AccuUsageReports;
}
void SmPolicyUpdateContextData::setAccuUsageReports(std::vector<AccuUsageReport> const& value)
{
...
std::vector<AppDetectionInfo> SmPolicyUpdateContextData::getAppDetectionInfos() const
{
    return m_AppDetectionInfos;
}
void SmPolicyUpdateContextData::setAppDetectionInfos(std::vector<AppDetectionInfo> const& value)
{
...
void SmPolicyUpdateContextData::setRuleReports(std::vector<RuleReport> const& value)
{
    m_RuleReports = value;
...
std::vector<SessionRuleReport> SmPolicyUpdateContextData::getSessRuleReports() const
{
    return m_SessRuleReports;
}
void SmPolicyUpdateContextData::setSessRuleReports(std::vector<SessionRuleReport> const& value)
{
...
std::vector<QosNotificationControlInfo> SmPolicyUpdateContextData::getQncReports() const
{
    return m_QncReports;
}
void SmPolicyUpdateContextData::setQncReports(std::vector<QosNotificationControlInfo> const& value)
{
    m_QncReports = value;
...
std::vector<QosMonitoringReport> SmPolicyUpdateContextData::getQosMonReports() const
{
    return m_QosMonReports;
}
void SmPolicyUpdateContextData::setQosMonReports(std::vector<QosMonitoringReport> const& value)
{
...
std::map<std::string, PresenceInfo> SmPolicyUpdateContextData::getRepPraInfos() const
{
    return m_RepPraInfos;
}
void SmPolicyUpdateContextData::setRepPraInfos(std::map<std::string, PresenceInfo> const& value)
{
    m_RepPraInfos = value;
...
void SmPolicyUpdateContextData::setUeInitResReq(UeInitiatedResourceRequest const& value)
{
...
CreditManagementStatus SmPolicyUpdateContextData::getCreditManageStatus() const
{
    return m_CreditManageStatus;
}
void SmPolicyUpdateContextData::setCreditManageStatus(CreditManagementStatus const& value)
{
...
PortManagementContainer SmPolicyUpdateContextData::getTsnPortManContDstt() const
{
    return m_TsnPortManContDstt;
}
void SmPolicyUpdateContextData::setTsnPortManContDstt(PortManagementContainer const& value)
{
...
std::vector<PortManagementContainer> SmPolicyUpdateContextData::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyUpdateContextData::setTsnPortManContNwtts(std::vector<PortManagementContainer> const& value)
{
...
std::vector<IpMulticastAddressInfo> SmPolicyUpdateContextData::getMulAddrInfos() const
{
    return m_MulAddrInfos;
}
void SmPolicyUpdateContextData::setMulAddrInfos(std::vector<IpMulticastAddressInfo> const& value)
{
