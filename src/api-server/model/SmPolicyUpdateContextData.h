...
public:
    ...
    void setRepPolicyCtrlReqTriggers(std::vector<PolicyControlRequestTrigger> const& value);
    ...
    void setTsnPortManContNwtts(std::vector<PortManagementContainer> const& value);
