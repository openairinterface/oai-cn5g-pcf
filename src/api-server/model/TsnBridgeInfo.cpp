...
bool TsnBridgeInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (nwttPortsIsSet())
    {
        ...
        success = value.validate(msg, currentValuePath + ".nwttPorts") && success;
...
bool TsnBridgeInfo::operator==(const TsnBridgeInfo& rhs) const
{
    ...
    ((!bridgeNameIsSet() && !rhs.bridgeNameIsSet()) || (bridgeNameIsSet() && rhs.bridgeNameIsSet() && getBridgeName() == rhs.getBridgeName())) &&
    
    
    ((!bridgeMacIsSet() && !rhs.bridgeMacIsSet()) || (bridgeMacIsSet() && rhs.bridgeMacIsSet() && getBridgeMac() == rhs.getBridgeMac())) &&
    
    
    ((!nwttPortsIsSet() && !rhs.nwttPortsIsSet()) || (nwttPortsIsSet() && rhs.nwttPortsIsSet() && getNwttPorts() == rhs.getNwttPorts())) &&
    
    
    ((!dsttPortIsSet() && !rhs.dsttPortIsSet()) || (dsttPortIsSet() && rhs.dsttPortIsSet() && getDsttPort() == rhs.getDsttPort())) &&
...
{
    j = nlohmann::json();
    if(o.bridgeNameIsSet())
        j["bridgeName"] = o.m_BridgeName;
    if(o.bridgeMacIsSet())
        j["bridgeMac"] = o.m_BridgeMac;
    if(o.nwttPortsIsSet() || !o.m_NwttPorts.empty())
        j["nwttPorts"] = o.m_NwttPorts;
    if(o.dsttPortIsSet())
        j["dsttPort"] = o.m_DsttPort;
