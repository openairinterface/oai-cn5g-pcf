...
void PresenceInfo::setGlobalRanNodeIdList(std::vector<GlobalRanNodeId> const& value)
{
...
void PresenceInfo::setGlobaleNbIdList(std::vector<GlobalRanNodeId> const& value)
{
