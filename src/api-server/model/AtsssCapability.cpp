...
AtsssCapability_anyOf::eAtsssCapability_anyOf AtsssCapability::getEnumValue() const
{
    return m_value.getValue();
}

void AtsssCapability::setEnumValue(AtsssCapability_anyOf::eAtsssCapability_anyOf  value)
{
