...
std::vector<PacketFilterInfo> UeInitiatedResourceRequest::getPackFiltInfo() const
{
    return m_PackFiltInfo;
}
void UeInitiatedResourceRequest::setPackFiltInfo(std::vector<PacketFilterInfo> const& value)
{
