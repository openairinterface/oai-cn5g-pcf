...
std::vector<RedirectInformation> TrafficControlData::getAddRedirectInfo() const
{
    return m_AddRedirectInfo;
}
void TrafficControlData::setAddRedirectInfo(std::vector<RedirectInformation> const& value)
{
...
void TrafficControlData::setRouteToLocs(std::vector<RouteToLocation> const& value)
{
    m_RouteToLocs = value;
