...
std::vector<Tai> PresenceInfoRm::getTrackingAreaList() const
{
...
std::vector<Ecgi> PresenceInfoRm::getEcgiList() const
{
    return m_EcgiList;
}
...
std::vector<Ncgi> PresenceInfoRm::getNcgiList() const
{
    return m_NcgiList;
}
...
std::vector<GlobalRanNodeId> PresenceInfoRm::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfoRm::setGlobalRanNodeIdList(std::vector<GlobalRanNodeId> const& value)
{
...
std::vector<GlobalRanNodeId> PresenceInfoRm::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfoRm::setGlobaleNbIdList(std::vector<GlobalRanNodeId> const& value)
{
