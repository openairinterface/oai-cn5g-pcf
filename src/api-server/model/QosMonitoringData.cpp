...
bool QosMonitoringData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<RequestedQosMonitoringParameter>& value = m_ReqQosMonParams;
...
bool QosMonitoringData::operator==(const QosMonitoringData& rhs) const
{
    ...
    ((!repFreqsIsSet() && !rhs.repFreqsIsSet()) || (repFreqsIsSet() && rhs.repFreqsIsSet() && getRepFreqs() == rhs.getRepFreqs())) &&
...
std::vector<RequestedQosMonitoringParameter> QosMonitoringData::getReqQosMonParams() const
{
    return m_ReqQosMonParams;
}
void QosMonitoringData::setReqQosMonParams(std::vector<RequestedQosMonitoringParameter> const& value)
{
...
void QosMonitoringData::setRepFreqs(std::vector<ReportingFrequency> const& value)
{
    m_RepFreqs = value;
