...
void to_json(nlohmann::json& j, const MaPduIndication_anyOf& o)
{
    ...
    switch (o.getValue())
    {
        ...
        case MaPduIndication_anyOf::eMaPduIndication_anyOf::REQUEST:
            j = "MA_PDU_REQUEST";
            break;
        case MaPduIndication_anyOf::eMaPduIndication_anyOf::_NETWORK_UPGRADE_ALLOWED:
...
void from_json(const nlohmann::json& j, MaPduIndication_anyOf& o)
{
    ...
    if (s == "MA_PDU_REQUEST") {
     ...
     o.setValue(MaPduIndication_anyOf::eMaPduIndication_anyOf::_NETWORK_UPGRADE_ALLOWED);
    }  else {
     std::stringstream ss;
