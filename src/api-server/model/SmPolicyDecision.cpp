...
bool SmPolicyDecision::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<PolicyControlRequestTrigger>& value = m_PolicyCtrlReqTriggers;
...
void SmPolicyDecision::setSessRules(std::map<std::string, SessionRule> const& value)
{
    m_SessRules = value;
...
void SmPolicyDecision::setPccRules(std::map<std::string, PccRule> const& value)
{
    m_PccRules = value;
...
void SmPolicyDecision::setChgDecs(std::map<std::string, ChargingData> const& value)
{
    m_ChgDecs = value;
    m_ChgDecsIsSet = true;
}
...
std::map<std::string, TrafficControlData> SmPolicyDecision::getTraffContDecs() const
{
    return m_TraffContDecs;
}
void SmPolicyDecision::setTraffContDecs(std::map<std::string, TrafficControlData> const& value)
{
...
void SmPolicyDecision::setUmDecs(std::map<std::string, UsageMonitoringData> const& value)
{
    m_UmDecs = value;
    m_UmDecsIsSet = true;
}
...
std::map<std::string, QosCharacteristics> SmPolicyDecision::getQosChars() const
{
    return m_QosChars;
}
void SmPolicyDecision::setQosChars(std::map<std::string, QosCharacteristics> const& value)
{
    m_QosChars = value;
...
std::map<std::string, QosMonitoringData> SmPolicyDecision::getQosMonDecs() const
{
    return m_QosMonDecs;
}
void SmPolicyDecision::setQosMonDecs(std::map<std::string, QosMonitoringData> const& value)
{
    m_QosMonDecs = value;
...
void SmPolicyDecision::setConds(std::map<std::string, ConditionData> const& value)
{
    m_Conds = value;
    m_CondsIsSet = true;
}
...
std::vector<PolicyControlRequestTrigger> SmPolicyDecision::getPolicyCtrlReqTriggers() const
{
    return m_PolicyCtrlReqTriggers;
}
void SmPolicyDecision::setPolicyCtrlReqTriggers(std::vector<PolicyControlRequestTrigger> const& value)
{
...
void SmPolicyDecision::setLastReqRuleData(std::vector<RequestedRuleData> const& value)
{
...
void SmPolicyDecision::setPraInfos(std::map<std::string, PresenceInfoRm> const& value)
{
    m_PraInfos = value;
...
void SmPolicyDecision::setRelCause(SmPolicyAssociationReleaseCause const& value)
{
    m_RelCause = value;
...
void SmPolicyDecision::setTsnPortManContDstt(PortManagementContainer const& value)
{
...
std::vector<PortManagementContainer> SmPolicyDecision::getTsnPortManContNwtts() const
{
    return m_TsnPortManContNwtts;
}
void SmPolicyDecision::setTsnPortManContNwtts(std::vector<PortManagementContainer> const& value)
{
