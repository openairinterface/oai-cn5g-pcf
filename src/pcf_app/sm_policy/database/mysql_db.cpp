...
std::vector<std::string> mysql_db::getDefaultPolicyDecision() {
  ...
  try {
    ...
    throw std::runtime_error("Default policy rules not found.");
  } catch (const std::exception& e) {
    Logger::pcf_db().error(
...
SupiPolicyDecision mysql_db::getSupiPolicyDecision(const std::string& supi) {
  ...
  try {
    ...
    throw std::runtime_error("SupiPolicyDecision object not found.");
  } catch (const std::exception& e) {
    Logger::pcf_db().error(
...
DnnPolicyDecision mysql_db::getDnnPolicyDecision(const std::string& dnn) {
  ...
  try {
    ...
    throw std::runtime_error("DnnPolicyDecision object not found.");
  } catch (const std::exception& e) {
    Logger::pcf_db().error(
...
SlicePolicyDecision mysql_db::getSlicePolicyDecision(const Snssai& slice) {
  ...
  try {
    ...
    Logger::pcf_db().error(
        ...
        json_slice.dump());
    throw std::runtime_error("SlicePolicyDecision object not found.");
  } catch (const std::exception& e) {
    Logger::pcf_db().error(
...
QosData mysql_db::getQosData(const std::string& qosId) {
  ...
  try {
    ...
    throw std::runtime_error("QosData object not found.");
  } catch (const std::exception& e) {
...
bool mysql_db::deleteQosData(const std::string& qosId) {
  ...
  try {
    ...
    throw std::runtime_error("QosData with id " + qosId + " does not exist.");
  } catch (const std::exception& e) {
...
TrafficControlData mysql_db::getTrafficControlData(const std::string& tcId) {
  ...
  try {
    ...
    throw std::runtime_error("TrafficControlData object not found.");
  } catch (const std::exception& e) {
    Logger::pcf_db().error(
...
oai::model::pcf::PccRule mysql_db::getPccRule(const std::string& pccRuleId) {
  ...
  try {
    ...
    throw std::runtime_error("PccRule object not found.");
  } catch (const std::exception& e) {
