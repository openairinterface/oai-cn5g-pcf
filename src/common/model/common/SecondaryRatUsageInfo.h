...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::common::QosFlowUsageReport> getQosFlowsUsageData() const;
    void setQosFlowsUsageData(std::vector<oai::model::common::QosFlowUsageReport> const& value);
    bool qosFlowsUsageDataIsSet() const;
    void unsetQosFlowsUsageData();
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::model::common::VolumeTimedReport> getPduSessionUsageData() const;
    void setPduSessionUsageData(std::vector<oai::model::common::VolumeTimedReport> const& value);
