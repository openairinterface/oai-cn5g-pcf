...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::model::common::GlobalRanNodeId> getGlobalRanNodeIdList() const;
    void setGlobalRanNodeIdList(std::vector<oai::model::common::GlobalRanNodeId> const& value);
    ...
    void setGlobaleNbIdList(std::vector<oai::model::common::GlobalRanNodeId> const& value);
