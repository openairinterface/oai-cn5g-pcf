...
class Logger {
 public:
  ...
  static _Logger& pcf_app() { return *singleton().m_pcf_app; }
  static _Logger& pcf_sbi() { return *singleton().m_pcf_sbi; }
  static _Logger& pcf_api_server() { return *singleton().m_pcf_api_server; }
